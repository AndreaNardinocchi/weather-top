...
//router.post("/station/addchartreport", stationController.addChartReport);
//router.post("/stationreading/:id/addautoreport", stationController.addManualReport);
//router.post("/station/:id/addreport", stationController.addAutoReport);
//router.post("/stationreading/:id/addreport", stationController.addAutoReport);
